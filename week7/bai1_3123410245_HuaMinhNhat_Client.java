...
public class bai1_3123410245_HuaMinhNhat_Client {
    ...
    public bai1_3123410245_HuaMinhNhat_Client(String host, int port, int bufferSize){
        this.host = host;
        this.port = port;
    ...
    private String getInput(Scanner scanner){
        System.out.print("Nhập link Tiki: ");
    ...
    public static void main(String[] args) {
        bai1_3123410245_HuaMinhNhat_Client client = new bai1_3123410245_HuaMinhNhat_Client("127.0.0.1", 1234, 1024);
        client.start();
    }
}
