...
public class client {
    ...
    public void start() {
        try (DatagramSocket socket = new DatagramSocket(); Scanner scanner = new Scanner(System.in)) {
            ...
            System.out.println("====== CHUONG TRINH CLIENT DA CHUC NANG ======");
            System.out.println("Cac lenh ho tro:");
            System.out.println(" 1. Tra cuu thoi tiet: weather <dia danh>");
            System.out.println(" 2. Chuyen doi co so : convert <nguon> <dich> <so>");
            System.out.println(" 3. Thoat            : exit");
            System.out.println("==============================================");
    ...
    public static void main(String[] args) {
        client client = new client("localhost", 9876, 1024);
        client.start();
    }
}
